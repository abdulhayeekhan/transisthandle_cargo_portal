    ...
    <DashboardLayout>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <form>
            <Grid container spacing={2}>
              {/* Company and Ship From */}
              <Grid item xs={12} sm={6}>
                <TextField label="Company" fullWidth />
              </Grid>
              <Grid item xs={12} sm={6}>
                <TextField label="Ship From" defaultValue="ESCM GmbH" fullWidth />
              </Grid>

              {/* Country, Weight, and Dimensions */}
              ...
              {/* Additional fields for customs declaration */}
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select defaultValue="Merchandise">
                    ...
                    {/* Add other contents options as needed */}
                  </Select>
                </FormControl>
              </Grid>
              <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField label="Quantity" type="number" defaultValue="1" fullWidth />
              </Grid>
              <Grid item xs={12} sm={6}>
